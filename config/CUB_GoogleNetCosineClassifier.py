...
networks['feat_model'] = {'def_file': 'architectures/googlenet_master.py', 'pretrained': None, 'opt': net_optionsF, 'optim_params': net_optim_paramsF}
...
net_optionsC = {'classifier_type': 'cosine', 'weight_generator_type': 'none', 'nKall': nKbase, 'nFeat':1024, 'scale_cls': 10}
