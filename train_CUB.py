...
from dataloader import MiniImageNet, CUB_200_2011, FewShotDataloader
...
dataset_train = CUB_200_2011(phase=train_split)
dataset_test = None # MiniImageNet(phase=test_split)
...
dloader_test = None # FewShotDataloader(
